...
// Shaders
#include "cece/plugins/parasite/vs.phage.hpp"
#include "cece/plugins/parasite/fs.phage.hpp"
...
DrawablePhage::DrawablePhage(render::Context& context)
...
void DrawablePhage::draw(render::Context& context, RealType size, RealType budSize,
