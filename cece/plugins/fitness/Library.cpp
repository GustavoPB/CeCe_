...
class fitnessApi : public plugin::Api
{
    ...
    {
        context.registerModule<plugin::fitness::Module>("fitness");
    }
    ...
    {
        context.unregisterModule("fitness");
    }
...
CECE_DEFINE_PLUGIN(fitness, fitnessApi)
